...
function valid()
{
 var a = document.lead.eid.value;
 var b = document.lead.pwd.value;

if(a=="")
 {
   alert("Employee Id field should not be empty!!!");
   document.lead.eid.focus();
   return false;
 }
...
<img src="prof.png" class="avatar">
        <h1>Leader Login</h1>
<form name="lead" action="lsuccess.jsp" method="post" onsubmit="return valid()">
<table cellspacing=20>
<tr><td colspan=2>
<center>
</center></td></tr>
<tr><td>Enter Employee Id</td><td>
       <input type="number"     name="lid" id="lid" placeholder="Enter Employee Id" onchange="validateeid()"><span id="err1"></span></td></tr>
<tr><td>Enter Password</td><td>
<input type="password" name="lpwd" id="pwd" placeholder="Enter Password" onchange="validatepwd()"><span id="err2"></span></td></tr></table><br><br>
