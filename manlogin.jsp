<html> 
<head>
<title>RLP Tech Development</title><style>
...
function valid()
{
 var a = document.man.eid.value;
 var b = document.man.pwd.value;

if(a=="")
 {
   alert("Employee Id field should not be empty!!!");
   document.man.eid.focus();
   return false;
 }
...
<form name="man" action="msuccess.jsp" method="post" onsubmit="return valid()">
<table cellspacing=20>
<tr><td colspan=2></td></tr>
<tr><td>Enter Employee Id</td><td>
<input type="number" id="eid"  name="mid" placeholder="Enter Employee Id" onchange="validateeid()"><span id="err1"></span></td></tr>
