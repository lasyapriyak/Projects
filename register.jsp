...
<form action="regist" name="f" method="post" onsubmit="return valid()" enctype="multipart/form-data">
<table align="center" cellspacing=30>
<tr>
<td>Full Name</td>
<td><input type="text" name="fullname" id="name" onkeyup="validatefname()"><span id="err1"></span></td>
</tr>
<tr>
<td>Employee Id</td>
<td><input type="number" name="empid" id="eid" onkeyup="validateeid()"><span id="err4"></span></td>
</tr>
<tr>
<td>Email Address</td>
...
<tr>
<td>Password</td>
<td><input type="password" name="pwd" id="pwd" onchange="validatepwd()"><span id="err2"></span></td>
</tr>
<tr>
<td>Confirm Password</td>
<td><input type="password" name="cpwd" id="cpwd" onchange="validatecpwd()" ><span id="err3"></span></td>
</tr>
<tr>
<td>Select Gender</td>
...
<tr>
<td>Designation</td>
<td><input type="text" name="designation" id="designation" ><span id="err22"></span></td>
</tr>
<tr>
<td>Address</td>
...
<tr>
<td>Phone Number</td>
<td><input type="number" name="mobileno" id="phno"></td>
</tr>

<tr>
<td>Upload Photo</td>
<td><input type="file" name="photo" id="fileToUpload"></td>
</tr>
</table>
<center>
